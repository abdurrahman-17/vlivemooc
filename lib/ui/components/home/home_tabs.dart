...
import 'package:vlivemooc/ui/components/coaches/coaches.dart';
import 'package:vlivemooc/ui/components/courses/courses.dart';
...
class HomeTabsState extends State<HomeTabs> with TickerProviderStateMixin {
  ...
  final List _titleList = ["Home", "Videos", "Courses", "Coaching", "Events"];
  ...
  final Color _backgroundOn = AppColors.primaryColor;
  final Color _backgroundOff = Colors.grey.shade200;
      ...
      children: [
        ...
        Flexible(
          ...
          children: <Widget>[
            ...
            const KeepAliveMixin(child: Videos()),
            const KeepAliveMixin(child: Courses()),
            const KeepAliveMixin(child: Coaches()),
            const KeepAliveMixin(child: Events())
          ],
        )),
      ],
    );
